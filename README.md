...
después de agregar estos 2 nuggets, debes agregar dapr a tu programa.cs
Este es un ejemplo de cómo puedes hacerlo.

<img width="1106" alt="Captura de pantalla 2023-02-13 a la(s) 12 35 46" src="https://user-images.githubusercontent.com/65357617/218516777-75049c82-23cf-48a0-8281-1b1c014dbaf4.png">

después de agregar dapr a su program.cs, ahora puede comenzar a implementar dapr.
...
Como puede ver, primero debe crear un dapr client con el tipo HttpClient especificando el nombre del sidecar que se está comunicando, luego debe especificar la ruta (por ejemplo, subscribe) donde lo está enviando.

Entonces, si la respuesta es SuccessStatusCode (200) devuelve un mensaje que dice que el evento publicado tuvo éxito, si es otra respuesta, significa que el mensaje no llegó.
    
Ahora vamos al servicio Receiver. En este también necesita agregar dapr en su program.cs también.
...
Aquí podemos ver cómo el controlador está recibiendo el mensaje.


Así funciona dapr en estos dos microservicios.
...
Aquí ejecutamos dapr, pero especificamos algunos atributos como la identificación de la aplicación y el puerto de la aplicación, y luego ejecutamos dotnet.

Después de ejecutar los comandos, podrá enviar una solicitud en el extremo del remitente y, si todo va bien, verá esto.
